...
<body style="background-image: url('../../../images/bg.jpg'); background-repeat: no-repeat;
  ...
  <form class="form_container" action="/new-user" method="post">
    @csrf
    <div class="img"><img src="../../../images/NextInLogo.png" width="150" height="150"/></div>
    <div class="title_container">
      <p class="title">Register Account</p>
      <span class="subtitle">Next In: Inventory Management System</span>
    </div>
    @if ($errors->any())
    ...
    <div class="input_container">
      ...
      <input placeholder="email" name="name" value="{{old('name')}}" type="text" class="input_field" required>
    </div>
    <div class="input_container">
      ...
      <input placeholder="email" name="login-email" value="{{old('login-email')}}" type="text" class="input_field" required>
    </div>
    <div class="input_container">
      ...
      <input placeholder="Password" name="login-password" value="{{old('login-password')}}" type="password" class="input_field" required>
    </div>
    <button class="sign-in_btn">Sign Up</button>
